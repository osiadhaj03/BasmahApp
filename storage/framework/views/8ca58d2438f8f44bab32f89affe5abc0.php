...
<body>    <!-- Floating Particles -->
                ...
                <?php else: ?>
                    <div class="text-center" data-aos="fade-up" data-aos-delay="3400">
                        <div class="d-flex flex-column flex-md-row justify-content-center align-items-center gap-3 mb-4">
                            ...
                            مرحباً <strong><?php echo e(auth()->user()->name); ?></strong> - 
                            <span class="badge" style="background: rgba(255, 255, 255, 0.2); color: white;">
                                <?php echo e(auth()->user()->role === 'admin' ? 'مدير النظام' : 
    ...
    <script>
        ...
        <?php if(session('success')): ?>            // Create animated success notification
...
<?php /**PATH C:\Users\abdul\OneDrive\Documents\BasmahApp\resources\views/welcome-basmah.blade.php ENDPATH**/ ?>