...
<body>
    <!-- Toggle View Button -->
    <a href="<?php echo e(route('welcome.premium')); ?>" class="toggle-view-btn" title="التبديل إلى الواجهة المتطورة">
        ...
        <div class="hero-card text-center">
            ...
            <?php if(auth()->guard()->guest()): ?>
                <div class="d-flex flex-column flex-md-row justify-content-center align-items-center gap-3 mb-4">
                    <!-- تسجيل طالب جديد -->
                    <a href="<?php echo e(route('student.register.form')); ?>" class="btn btn-success-custom btn-custom">
                        <i class="fas fa-user-plus me-2"></i>
                        تسجيل طالب جديد
                    </a>
                    
                    <!-- تسجيل الدخول -->
                    <a href="<?php echo e(route('admin.login')); ?>" class="btn btn-primary-custom btn-custom">
            ...
            <?php else: ?>
                <div class="d-flex flex-column flex-md-row justify-content-center align-items-center gap-3 mb-4">
                    <?php if(auth()->user()->role === 'admin'): ?>
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-primary-custom btn-custom">
                            <i class="fas fa-tachometer-alt me-2"></i>
                            لوحة إدارة النظام
                        </a>
                    <?php elseif(auth()->user()->role === 'teacher'): ?>
                        <a href="<?php echo e(route('teacher.dashboard')); ?>" class="btn btn-success-custom btn-custom">
                            <i class="fas fa-chalkboard-teacher me-2"></i>
                            لوحة تحكم المعلم
                        </a>
                    <?php elseif(auth()->user()->role === 'student'): ?>
                        <a href="<?php echo e(route('student.dashboard')); ?>" class="btn btn-outline-custom btn-custom">
                ...
                <div class="alert alert-success border-0" style="background: rgba(86, 171, 47, 0.1); border-radius: 15px;">
                    ...
                    مرحباً <strong><?php echo e(auth()->user()->name); ?></strong> - <?php echo e(auth()->user()->role === 'admin' ? 'مدير النظام' : 
                    ...
                    <div class="row">
                        <div class="col-md-6 text-md-start text-center mb-3 mb-md-0">
                            ...
                            <p class="mb-0">
                                ...
                                <?php echo e(now()->format('Y')); ?> &copy; جميع الحقوق محفوظة
                            </p>
                        </div>
    ...
    <?php if(session('success')): ?>
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                notification.innerHTML = '<i class="fas fa-check-circle me-2"></i><?php echo e(session('success')); ?>';
    ...
    <?php if(session('error')): ?>
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                notification.innerHTML = '<i class="fas fa-exclamation-circle me-2"></i><?php echo e(session('error')); ?>';
                document.body.appendChild(notification);
...
<?php /**PATH C:\Users\abdul\OneDrive\Documents\BasmahApp\resources\views/welcome-simple.blade.php ENDPATH**/ ?>