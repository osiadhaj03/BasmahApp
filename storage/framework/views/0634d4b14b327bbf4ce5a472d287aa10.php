            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <div class="h4 mb-0"><?php echo e($data['totalBooks'] ?? 0); ?></div>
                    </div>
                    <div class="align-self-center">
                        <i class="fas fa-book fa-2x text-white-50"></i>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <div class="h4 mb-0"><?php echo e($data['publishedBooks'] ?? 0); ?></div>
                    </div>
                    <div class="align-self-center">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <div class="h4 mb-0"><?php echo e($data['totalArticles'] ?? 0); ?></div>
                    </div>
                    <div class="align-self-center">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <div class="h4 mb-0"><?php echo e($data['publishedArticles'] ?? 0); ?></div>
                    </div>
                    <div class="align-self-center">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <div class="h4 mb-0"><?php echo e($data['totalNews'] ?? 0); ?></div>
                    </div>
                    <div class="align-self-center">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div>
                        ...
                        <div class="h4 mb-0"><?php echo e($data['urgentNews'] ?? 0); ?></div>
                    </div>
                    <div class="align-self-center">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\osaid\BasmahApp\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>