...
<div class="text-center">
    <p class="mb-2">
        لديك حساب بالفعل؟ 
        <a href="<?php echo e(route('admin.login')); ?>" class="text-decoration-none" style="color: var(--islamic-gold); font-weight: 600;">
            تسجيل الدخول
        </a>
    </p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u994369532/basmah/resources/views/auth/student-register-new.blade.php ENDPATH**/ ?>