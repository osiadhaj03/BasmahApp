...
function loadQRImage() {
    ...
    if (tokenData && tokenData.can_generate_qr) {
        ...
        const qrUrl = `<?php echo e(url('/quick-qr/' . $lesson->id)); ?>?t=${Date.now()}`;
        container.innerHTML = `
            <img src="${qrUrl}" 
                 alt="QR Code" 
                 class="img-fluid" 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\osaid\BasmahApp\resources\views/admin/lessons/qr-display.blade.php ENDPATH**/ ?>