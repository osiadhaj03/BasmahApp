        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    @guest
                        <a href="{{ route('student.register.form') }}" class="btn btn-outline-primary btn-sm px-3 py-2" style="border-color: var(--gold); color: var(--gold); border-radius: 25px; font-weight: 600; transition: var(--transition);">
                            <i class="fas fa-user-plus me-1"></i>
                            تسجيل طالب جديد
                        </a>
                        <a href="{{ route('admin.login') }}" class="btn btn-primary btn-sm px-3 py-2" style="background: linear-gradient(135deg, var(--teal), var(--teal-light)); border: none; border-radius: 25px; font-weight: 600; transition: var(--transition);">
                            <i class="fas fa-sign-in-alt me-1"></i>
                            تسجيل الدخول
                        </a>
                    @else
                        @if(auth()->user()->role === 'admin')
                            <a href="{{ route('admin.dashboard') }}" class="btn btn-success btn-sm px-3 py-2" style="background: linear-gradient(135deg, var(--gold), var(--gold-light)); border: none; border-radius: 25px; font-weight: 600;">
                                <i class="fas fa-tachometer-alt me-1"></i>
                                لوحة الإدارة
                            </a>
                        @elseif(auth()->user()->role === 'teacher')
                            <a href="{{ route('teacher.dashboard') }}" class="btn btn-success btn-sm px-3 py-2" style="background: linear-gradient(135deg, var(--gold), var(--gold-light)); border: none; border-radius: 25px; font-weight: 600;">
                                <i class="fas fa-chalkboard-teacher me-1"></i>
                                لوحة المعلم
                            </a>
                        @else
                            <a href="{{ route('student.dashboard') }}" class="btn btn-success btn-sm px-3 py-2" style="background: linear-gradient(135deg, var(--gold), var(--gold-light)); border: none; border-radius: 25px; font-weight: 600;">
                                <i class="fas fa-user-graduate me-1"></i>
                                لوحة الطالب
                            </a>
                        @endif
                        <a href="{{ route('admin.logout') }}" class="btn btn-outline-danger btn-sm px-3 py-2" style="border-color: #dc3545; color: #dc3545; border-radius: 25px; font-weight: 600;">
